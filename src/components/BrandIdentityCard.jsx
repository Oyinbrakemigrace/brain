...
function BrandIdentityCard({ data }) {
    return (
            ...
            <div>
                ...
                <div className='bg-stone-700/70 group-hover:bg-gradient-to-r group-hover:from-gray-600 mt-8 group-hover:to-zinc-800 border border-zinc-600 backdrop-blur-2xl  p-4 rounded-2xl'>
                    ...
                    <div className='flex justify-between items-center mt-6'>
                        <Link to={data.projectHref} className='flex items-center gap-3 bg-[#272727] group-hover:bg-gradient-to-l group-hover:from-gray-600 group-hover:to-zinc-800 lg:px-6 px-4 py-3 text-sm lg:text-base rounded-3xl'><span>View website</span> <MdArrowForward /></Link>
                        <div>
