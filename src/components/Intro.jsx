...
function Intro() {
    return (
        <div className='h-full w-full lg:mt-10 mt-8'>
            ...
            <div className='hidden lg:block bg-gradient-to-r from-[#676767] hover:bg-gradient-to-l hover:from-[#321D4A] hover:to-[#4A535A] mt-8 to-[#313131] rounded-[32px] shadow-inner border border-zinc-600 backdrop-blur-[20px] m-auto w-[14%] py-4'>
